...
public class Block extends TableImpl<BlockRecord> {
     ...
     */
    public final TableField<BlockRecord, Long> PREVIOUS_BLOCK_ID = createField("previous_block_id", org.jooq.impl.SQLDataType.BIGINT.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<BlockRecord, byte[]> PREVIOUS_BLOCK_HASH = createField("previous_block_hash", org.jooq.impl.SQLDataType.VARBINARY(32).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARBINARY)), this, "");
     ...
     */
    public final TableField<BlockRecord, Long> NEXT_BLOCK_ID = createField("next_block_id", org.jooq.impl.SQLDataType.BIGINT.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<BlockRecord, byte[]> ATS = createField("ats", org.jooq.impl.SQLDataType.BLOB.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.BLOB)), this, "");
