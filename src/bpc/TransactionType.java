  ...
  public abstract static class BurstMining extends TransactionType {
    ...
    public static final TransactionType REWARD_RECIPIENT_ASSIGNMENT = new BurstMining() {
      ...
      void validateAttachment(Transaction transaction) throws BurstException.ValidationException {
        ...
        if (!BPC.getFluxCapacitor().getValue(FluxValues.REWARD_RECIPIENT_ENABLE, height)) {
          throw new BurstException.NotCurrentlyValidException("Reward recipient assignment not allowed before block " + BPC.getFluxCapacitor().getStartingHeight(FluxValues.REWARD_RECIPIENT_ENABLE));
        }
      }
