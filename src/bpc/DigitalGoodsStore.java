...
public final class DigitalGoodsStore {
  ...
  public static class Goods {
    ...
    private static BurstKey.LongKeyFactory<Goods> goodsDbKeyFactory() {
      return BPC.getStores().getDigitalGoodsStoreStore().getGoodsDbKeyFactory();
    }

    private static VersionedEntityTable<Goods> goodsTable() {
      return BPC.getStores().getDigitalGoodsStoreStore().getGoodsTable();
    }
  ...
  public static class Purchase {
    ...
    private static BurstKey.LongKeyFactory<Purchase> purchaseDbKeyFactory() {
      return BPC.getStores().getDigitalGoodsStoreStore().getPurchaseDbKeyFactory();
    }

    private static BurstKey.LongKeyFactory<Purchase> feedbackDbKeyFactory() {
      return BPC.getStores().getDigitalGoodsStoreStore().getFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, EncryptedData> feedbackTable() {
      return BPC.getStores().getDigitalGoodsStoreStore().getFeedbackTable();
    }

    private static BurstKey.LongKeyFactory<Purchase> publicFeedbackDbKeyFactory() {
      return BPC.getStores().getDigitalGoodsStoreStore().getPublicFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, String> publicFeedbackTable() {
      return BPC.getStores().getDigitalGoodsStoreStore().getPublicFeedbackTable();
    }
