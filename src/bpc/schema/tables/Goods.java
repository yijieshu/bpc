...
public class Goods extends TableImpl<GoodsRecord> {
     ...
     */
    public final TableField<GoodsRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.CLOB.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.CLOB)), this, "");

    /**
     * The column <code>DB.goods.tags</code>.
     */
    public final TableField<GoodsRecord, String> TAGS = createField("tags", org.jooq.impl.SQLDataType.VARCHAR(100).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
