...
/**
 * Java LogManager extension for use with BPC
 */
class BurstLogManager extends LogManager {
   ...
   * done terminating the BPC processes.
   */
   ...
   * This allows us to continue to use logging facilities during BPC shutdown.
   */
  @Override
  public void reset() {
  ...
  /**
   * BPC shutdown is now complete, so call LogManager.reset() to terminate
   * the log handlers.
   */
  void burstShutdown() {
    super.reset();
