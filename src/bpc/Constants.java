...
public final class Constants {
  ...
  public static final int BURST_DIFF_ADJUST_CHANGE_BLOCK = 40000;
  ...
  public static final int MAX_ROLLBACK = BPC.getPropertyService().getInt(Props.DB_MAX_ROLLBACK);
  ...
  public static final Version MIN_VERSION = Version.parse("v1.0.0");

  static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (BPC.getPropertyService().getBoolean(Props.DEV_TESTNET) ? 50 : 100) * ONE_BURST;
