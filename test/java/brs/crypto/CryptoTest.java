...
public class CryptoTest {
    ...
    public void testCryptoSha256() {
        ...
        assertEquals("d059c5e6b6715f1e1dd83295e804d4f5fbc560cd10befde400434d19afdf4cfe", Convert.toHexString(sha256.digest(stringToBytes("BPC Apps Team"))));
    }
    ...
    public void testCryptoShabal256() {
        ...
        assertEquals("4d92fb90793baaefabf4691cdcf4f1332ccd51c4a74f509a4b9a338eddb39e09", Convert.toHexString(shabal256.digest(stringToBytes("BPC Apps Team"))));
    }
    ...
    public void testCryptoRipemd160() {
        ...
        assertEquals("b089c88c2f81e87326c22b2df66dca6857f690a0", Convert.toHexString(ripemd160.digest(stringToBytes("BPC Apps Team"))));
    }
    ...
    public void testCryptoGetPublicKey() {
        ...
        assertEquals("25fa4a7c542f042ad86102addfd45272bbec1b350e94a483c4dc93f9d123f408", Convert.toHexString(Crypto.getPublicKey("BPC Apps Team")));
    }
    ...
    public void testCryptoGetPrivateKey() {
        ...
        assertEquals("d059c5e6b6715f1e1dd83295e804d4f5fbc560cd10befde400434d19afdf4c7e", Convert.toHexString(Crypto.getPrivateKey("BPC Apps Team")));
    }
    ...
    public void testCryptoSign() {
        ...
        assertEquals("46ab525630fd4f2266d78309a04153dd7d69c8d3c77765956eff1b86cc4e5a0d8d0d8df1cfe8300617551361b99f54b5db7afbd8ffa0a21ddcdac2cfdec57b71", Convert.toHexString(Crypto.sign(stringToBytes("BPC Apps Team"), TestConstants.TEST_SECRET_PHRASE)));
    }
    ...
    public void testCryptoVerify() {
        ...
        assertTrue(Crypto.verify(Convert.parseHexString("46ab525630fd4f2266d78309a04153dd7d69c8d3c77765956eff1b86cc4e5a0d8d0d8df1cfe8300617551361b99f54b5db7afbd8ffa0a21ddcdac2cfdec57b71"), stringToBytes("BPC Apps Team"), publicKey, true));
    }
    ...
    public void testCryptoRsEncode() {
        ...
        assertEquals("T7XD-7M3X-MB9F-38DU8", Crypto.rsEncode(burstCrypto.getBurstAddressFromPassphrase("BPC Apps Team").getBurstID().getSignedLongId()));
    }
    ...
    public void testCryptoRsDecode() {
        ...
        assertEquals(burstCrypto.getBurstAddressFromPassphrase("BPC Apps Team").getBurstID().getSignedLongId(), Crypto.rsDecode("T7XD-7M3X-MB9F-38DU8"));
    }
}
